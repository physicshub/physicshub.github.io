...
import {handleSimulationsNav} from './Nav';
    ...
    <footer>
      <div className="footer-content">
        ...
        <div className="footer-section footer-links">
          ...
          <ul>
            {links.map(({ to, label, exact, portal }) => (
              <li key={to}>
      ...
      <div className="footer-bottom">
        <p>
          ...
          <a href="https://natureofcode.com/">Nature of Code</a> for the
          simulations.
        </p>
        <BackToTopButton />
      </div>
