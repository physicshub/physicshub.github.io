 ...
 */
export const useEditableBlock = (props: EditableProps, initialContent: string) => {
    ...
    return {
        isEditable: isEditing && onContentUpdate !== undefined && sectionIndex !== undefined && blockIndex !== undefined,
        handleEditEnd
    };
};
 ...
 */
export const normalizeItems = (rawItems: string[] | string | null): string[] => {
