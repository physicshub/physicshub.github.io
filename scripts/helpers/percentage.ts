 ...
 */
export const getPercentagesCommits = (contributors: Contributor[], c: Contributor) => {
...
export const getPercentagesAdditions = (
  ...
  const totalAdditions = contributorsStats.reduce((acc, curr) => acc + curr.additions, 0);
...
export const getPercentagesDeletions = (
  ...
  const totalDeletions = contributorsStats.reduce((acc, curr) => acc + curr.deletions, 0);
